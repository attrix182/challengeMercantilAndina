...
import { Component, OnInit, EventEmitter, ViewChild, TemplateRef, Output, Input } from '@angular/core';
...
export class FormCoberturasComponent implements OnInit {
    ...
    constructor(private apisSVC: ApisService, public stars: NgbRatingConfig, private modalService: NgbModal) {
        stars.max = 5;
        stars.readonly = true;
    }
