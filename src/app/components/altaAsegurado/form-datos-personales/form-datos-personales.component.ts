...
export class FormDatosPersonalesComponent extends BaseFormAbstract implements OnInit {
    ...
    constructor(private FB: FormBuilder, private apisSVC: ApisService, private alertSV: AlertService) {
        super();
    }
    ...
    definirMensajesError(): void {
        this.mensajesError = {
            ...
            contrasena: {
                ...
                pattern: 'La contraseña debe tener entre 8 y 30 caracteres, mayusculas, minusculas y numeros'
            }
        };
    }
    ...
    nextStep() {
        ...
        asegurado.provinciaCompleta = this.provincias.find((prov) => prov.id == this.formGroup.value.provincia);
        asegurado.ciudadCompleta = this.ciudades.find((ciudad) => ciudad.id == this.formGroup.value.ciudad);
